        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-12 sm:w-16 h-12 sm:w-16 bg-blue-400/30 rounded-full blur-lg"></div>
            </div>
          </div>
          ...
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1 text-center lg:text-left">
            <div className="space-y-3 sm:space-y-4">
              ...
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300">
                Driven by passion, powered by technology, and inspired to make an impact 
              </h2>
            </div>
            
            <p className="text-base sm:text-lg text-gray-500 dark:text-gray-400 leading-relaxed max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <a href="mailto:hansanisc@gmail.com" className="flex items-center justify-center sm:justify-start gap-3 glass-card p-3 sm:p-4 hover:bg-blue-600/20 dark:hover:bg-blue-600/20 transition-all duration-300 hover:scale-105 glow-effect text-sm sm:text-base text-gray-700 dark:text-gray-200">
                  ...
                  <span className="truncate"> hansanisc@gmail.com </span>
                </a>
